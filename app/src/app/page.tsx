  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="On-Time Delivery" value={kpiVal('On-Time Delivery', '92%')} status="warning" />
        ...
        <KPICard title="Active Suppliers" value={kpiVal('Active Suppliers', '247')} status="neutral" />
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="Single-Source Risk" value={kpiVal('Single-Source Risk', '₫42B exposure')} />
        <KPICard title="Buffer Stock" value={kpiVal('Buffer Stock', '8 days')} />
        <KPICard title="Alternatives Qualified" value={kpiVal('Alternatives Qualified', '84%')} />
      </div>
      <Chart
